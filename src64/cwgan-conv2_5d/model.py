...
def flt2_5d_to_3d(filter, axis, depth):
	...
	with tf.variable_scope(ALPHA_NAME):
		alpha = 0.1*bias_variable([])	# init to be 0.1
	...
	def __init__(self, z_size=5, ngf=9, name="g_"):
		with tf.variable_scope(name):
			...
			self.W = {
				...
				'h5': weights_2_5_d([4, 4, 4, ngf*8, ngf*16]),
				'h6': weights_2_5_d([4, 4, 4, ngf*16, ngf*32]),

				'dh1': weights_2_5_d([4, 4, 4, ngf*16, ngf*32]),
				'dh2': weights_2_5_d([4, 4, 4, ngf*8, ngf*16]),
				'dh3': weights_2_5_d([4, 4, 4, ngf*4, ngf*8]),
				'dh4': weights_2_5_d([4, 4, 4, ngf*2, ngf*4]),
				'dh5': weights_2_5_d([4, 4, 4, ngf, ngf*2]),
				'dh6': weights_2_5_d([4, 4, 4, 3, ngf])
			}
