...
class Generator(object):
	...
	def __init__(self, z_size=5, ngf=5, name="g_"):
		with tf.variable_scope(name):
			self.name = name
			self.ngf = ngf
			...
			self.W = {
				...
				'dh2': weight_variable([4, 4, 4, ngf*4, ngf*8+ngf*8]),
				'dh3': weight_variable([4, 4, 4, ngf*2, ngf*4+ngf*4]),
				'dh4': weight_variable([4, 4, 4, ngf, ngf*2+ngf*2]),
				'dh5': weight_variable([4, 4, 4, 3, ngf+ngf])
			}
