...
def maxpooling3d(x, stride=2):
	return tf.nn.max_pool3d(x, ksize=[1,stride,stride,stride,1], strides=[1,stride,stride,stride,1], padding='SAME')
...
### cgan+mask, output multi-resolution rgba
### 
...
# 		# rgba_16 from dh4
# 		rgb_16 = dh4[:,:,:,:,0:3]		#(n,16,16,16,3)
# 		a_16 = tf.nn.max_pool3d(a, ksize=[1,2,2,2,1], strides=[1, 2, 2, 2, 1], padding='SAME')	#(n,16,16,16,1)
# 		rgba_16 = self.mask(rgb_16,a_16)

# 		# rgba_32
# 		rgba_32 = self.mask(rgb,a)

# 		rgba_dict = {'16':rgb_16, '32':rgba_32}
# 		return rgba_dict
